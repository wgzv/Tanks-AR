...
* Product: XDreamer
* Author: XCSJ
* Create Date: 2020-04-30 13:02:53
*/

/*
	定义XDreamer与JS使用WebSocket进行网络数据通信；适用于Unity5.6之后的版本;
*/

var XDreamer_LibraryWebSockets = {
$webSocketInstances: [],
...
autoAddDeps(XDreamer_LibraryWebSockets, '$webSocketInstances');
mergeInto(LibraryManager.library, XDreamer_LibraryWebSockets);
